...
# Сценарий №1 Эксперт проставляет оценки студенту:
...
# Сценарий №2 Студент1 проставляет оценки лектору:
student_no_1.rate_lecturer(lecturer_1, 'Python', 3)
student_no_1.rate_lecturer(lecturer_1, 'Python', 3)
student_no_1.rate_lecturer(lecturer_1, 'English for IT', 3)
print(f'Сценарий №2 {lecturer_1.grades}')

# Сценарий №3 Студент2 проставляет оценки лектору (добавление к существующим):
...
print('*****Результат проверки работы функции рассчета среднего балла лекторов по всем курсам*****')
